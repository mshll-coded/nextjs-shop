...
const productsList = products.map((product) => (
  <div key={product.name} className="bg-zinc-900 rounded-3xl p-4 flex items-center shadow-lg w-[300px] h-[150px] gap-4 border-2 border-zinc-200/[.1]">
...
export default function Home() {
  return (
    <div className="bg-zinc-950 flex justify-center flex-col items-center pb-24 gap-6 min-h-screen container mx-auto">
      ...
      <div className="flex gap-8 flex-wrap justify-center items-center mx-20">{productsList}</div>
    </div>
  );
}
